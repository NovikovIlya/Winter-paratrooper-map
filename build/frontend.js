...
/* harmony import */ var d3_geo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! d3-geo */ "./node_modules/d3-geo/src/projection/mercator.js");
/* harmony import */ var d3_geo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! d3-geo */ "./node_modules/d3-geo/src/path/index.js");
...
function Map() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (svgRef.current && russiaGeoJson) {
      const svg = (0,d3_selection__WEBPACK_IMPORTED_MODULE_4__["default"])(svgRef.current);
  ...
  const width = 1200;
  const height = 600;
  const projection = (0,d3_geo__WEBPACK_IMPORTED_MODULE_5__["default"])().center([65, 57]).scale(500).translate([width / 2, height / 2]);
  const path = (0,d3_geo__WEBPACK_IMPORTED_MODULE_6__["default"])().projection(projection);
