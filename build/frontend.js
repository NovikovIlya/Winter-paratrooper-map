...
/* harmony import */ var d3_geo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! d3-geo */ "./node_modules/d3-geo/src/projection/mercator.js");
/* harmony import */ var d3_geo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! d3-geo */ "./node_modules/d3-geo/src/path/index.js");
...
const cities = _cities__WEBPACK_IMPORTED_MODULE_1__.citiesAll.map(item => ({
  ...item,
...
function HeroSection(props) {
  ...
  const [slug, setSlug] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('pohod-1991-snezhnogo-desanta-istoricheskogo-fakulteta');
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    fetch('https://raw.githubusercontent.com/codeforamerica/click_that_hood/master/public/data/russia.geojson').then(response => response.json()).then(data => setRussiaGeoJson(data));
  }, []);
  const width = 1200;
  const height = 600;
  const projection = (0,d3_geo__WEBPACK_IMPORTED_MODULE_3__["default"])().center([65, 57]).scale(800).translate([width / 2, height / 2]);
  const path = (0,d3_geo__WEBPACK_IMPORTED_MODULE_4__["default"])().projection(projection);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "min-h-screen bg-gray-100 p-8 flex justify-center ww"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " bg-white rounded-lg shadow-lg p-6 !w-[1200px] ww"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "border border-gray-300 rounded-lg overflow-hidden !flex !justify-center !w-[1200px] ww"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: width,
    height: height
  }, russiaGeoJson && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("g", null, russiaGeoJson.features.map((feature, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    key: index,
    d: path(feature) || '',
    fill: "#EAEAEC",
    stroke: "#D6D6DA"
...
/* harmony import */ var _HeroSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./HeroSection */ "./src/HeroSection.jsx");
...
function OurComponent(props) {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_tanstack_react_query__WEBPACK_IMPORTED_MODULE_5__.QueryClientProvider, {
    client: queryClient
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_HeroSection__WEBPACK_IMPORTED_MODULE_3__["default"], {
    props: props
  }));
}
})();
